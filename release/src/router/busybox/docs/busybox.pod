...
Currently available applets include:
	...
	du, echo, egrep, env, ether-wake, expr, fdisk, fgrep, find, free,
	grep, gunzip, gzip, head, ifconfig, insmod, ionice, kill, killall,
	klogd, less, ln, logger, login, ls, lsmod, md5sum, mdev, mkdir,
	mke2fs, mkfs.ext2, mkfs.ext3, mknod, modprobe, more, mount, mv,
	...
	tune2fs, udhcpc, umount, uname, uptime, usleep, vconfig, vi, watch,
	wc, which, zcat, zcip
